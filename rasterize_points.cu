	...
	const bool debug)
{
  ...
  return std::make_tuple(rendered, out_color, out_feature_map, out_depth, out_alpha, radii, geomBuffer, binningBuffer, imgBuffer, proj_2D, conic_2D, conic_2D_inv, gs_per_pixel, weight_per_gs_pixel, x_mu);
}
